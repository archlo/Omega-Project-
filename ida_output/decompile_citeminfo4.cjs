...
const BATCH4 = [
  { name: 'RegisterEquipItemInfo', addr: '0x5b8ef0' },
  { name: 'RegisterGachaponItemInfo', addr: '0x5bf040' },
  { name: 'GetItemSlot', addr: '0x5c3b20' },
  ...
  { name: 'IsQuestItem', addr: '0x5abaa0' },
  { name: 'IsPartyQuestItem', addr: '0x5abbe0' },
  { name: 'IsPickUpBlockItem', addr: '0x5abd20' },
  { name: 'IsSharableOnceItem_long', addr: '0x5ab820' },
  { name: 'IsAccountSharableItem_long', addr: '0x5ab6e0' },
  { name: 'IsScannableItem', addr: '0x5a7ab0' },
];
...
async function main() {
  for (let i = 0; i < BATCH4.length; i++) {
    ...
    console.log(`[${i+1}/${BATCH4.length}] ${m.name} @ ${m.addr}...`);
    try {
