export class WzConstants {
  static readonly AesUserKey = new Uint8Array([
  ...
  static readonly WzGmsIv = new Uint8Array([0x4D, 0x23, 0xC7, 0x2B]);
  static readonly WzEmptyIv = new Uint8Array(4);
  static readonly WzOffsetConstant = 0x581C3F6D;
}
