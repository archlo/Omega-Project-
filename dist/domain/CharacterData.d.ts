...
export interface SkillCooltimeEntry {
    skillId: number;
    cooltime: number;
}
export interface QuestRecordEntry {
    questId: number;
    value: string;
}
...
export interface MiniGameRecordEntry {
    gameId: number;
    win: number;
    draw: number;
    lose: number;
...
export interface CoupleRecordEntry {
...
export interface FriendRecordEntry extends CoupleRecordEntry {
    friendItemId: number;
}
/**
