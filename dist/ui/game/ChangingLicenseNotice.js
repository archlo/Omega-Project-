...
// OG: CUIChangingLicenseNotice — inherits CDialog (modal).
// WZ: UIWindow2.img/ChangingLicenseNotice/backgrnd
const PANEL_W = 280;
const PANEL_H = 140;
export class ChangingLicenseNotice extends GamePanel {
    _bg;
    onClose = null;
    constructor(opts = {}) {
        super();
        // OG: CUIChangingLicenseNotice loads from UIWindow2.img/ChangingLicenseNotice
        const bgNode = opts.uiWz?.GetItem('UIWindow2.img/ChangingLicenseNotice/backgrnd');
        ...
        const title = new Text({ text: 'License Notice', style: titleStyle });
        title.x = 10;
        title.y = 5;
        ...
        const body = new Text({ text: opts.message ?? 'Your license is changing.', style: bodyStyle });
        body.x = 10;
        body.y = 35;
...
//# sourceMappingURL=ChangingLicenseNotice.js.map