...
export class MonsterBook extends GamePanel {
    ...
    constructor(loader, ui, font) {
        ...
        this._background = mbProp?.Get('backgrnd') instanceof WzCanvas ? loader.Load(mbProp.Get('backgrnd')) : null;
...
//# sourceMappingURL=MonsterBook.js.map