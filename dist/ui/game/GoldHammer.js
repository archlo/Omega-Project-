...
export class GoldHammer extends GamePanel {
    OnConfirm = null;
    OnCancel = null;
    ...
    constructor(loader, ui, font) {
        ...
        this._background = ghProp?.Get('backgrnd') instanceof WzCanvas ? loader.Load(ghProp.Get('backgrnd')) : null;
        if (this._background)
...
//# sourceMappingURL=GoldHammer.js.map