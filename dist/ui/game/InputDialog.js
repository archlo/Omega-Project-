...
export class InputDialog extends GamePanel {
    ...
    constructor(opts = {}) {
        ...
        const dlgProp = opts.uiWz?.GetItem('UIWindow2.img/UtilDlgEx') instanceof WzProperty
            ? opts.uiWz.GetItem('UIWindow2.img/UtilDlgEx') : null;
        ...
        this._inputText.x = 64;
        this._inputText.y = 34;
    ...
    show(title, label, defaultValue, maxValue) {
    ...
    _confirm() {
        ...
        if (!Number.isFinite(value) || value <= 0)
            return;
        if (this._maxValue > 0 && value > this._maxValue)
            return;
