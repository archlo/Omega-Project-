...
export class LogoutGift extends GamePanel {
    _bg = new Graphics();
    _title = new Text({ text: 'Logout Gift', style: _titleStyle });
    _body = new Text({ text: 'A gift is waiting for you.', style: _bodyStyle });
    ...
    handleMouseButton(x, y, down) {
        ...
        if (this._hit(lx, ly, 148, 84, 58, 24)) {
...
//# sourceMappingURL=LogoutGift.js.map