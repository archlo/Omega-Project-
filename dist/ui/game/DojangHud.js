...
export class DojangHud {
     ...
     */
    onBossEnter(templateId, name, hpPct) {
     ...
     */
    updatePlayerStats(hp, maxHp, mp, maxMp) {
    ...
    static canUseSpecialArts(fieldType) {
        return fieldType === 14;
    }
    // --- Internal ---
    _bossNameStr = '';
    _updateBossBar(hpPct) {
...
//# sourceMappingURL=DojangHud.js.map