...
export class EntrustedShop extends GamePanel {
    ...
    _selectedItem = -1;
    _scrollOffset = 0;
    _enterTime = 0; // OG: m_tEnter
    _elapsedMs = 0; // OG: m_tPass
    // UI
    _bg;
    _dynamicChildren = [];
    _allButtons = [];
     ...
     */
    Open(isOwner, money, items, enterTime) {
        ...
        if (this._btArrange)
            this._btArrange.container.visible = isOwner;
        if (this._btCoin)
            this._btCoin.container.visible = isOwner;
        if (this._btBlackList)
            this._btBlackList.container.visible = isOwner;
        if (this._btVisitList)
            this._btVisitList.container.visible = isOwner;
    }
...
//# sourceMappingURL=EntrustedShop.js.map