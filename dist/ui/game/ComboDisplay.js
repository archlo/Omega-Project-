...
export class ComboDisplay {
    ...
    _bg = new Graphics();
    _digitContainer = new Container();
    _skillCmdContainer = new Container();
    _digits = [];
    _comboLevel = 0;
    _comboCount = 0;
    _visible = false;
    ...
    _skillCmdAttackLayer = null;
    _skillCmdBuffLayer = null;
    constructor() {
...
//# sourceMappingURL=ComboDisplay.js.map