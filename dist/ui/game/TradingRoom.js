...
export class TradingRoom extends GamePanel {
    ...
    _myItems = new Array(9).fill(null);
    _theirItems = new Array(9).fill(null);
    _myMoney = 0;
    _theirMoney = 0;
    _myConfirmed = false;
    ...
    constructor(loader, ui, font) {
        ...
        this._background = trProp?.Get('backgrnd') instanceof WzCanvas ? loader.Load(trProp.Get('backgrnd')) : null;
        if (this._background)
        ...
        this._theirLabel.x = THEIR_GRID_X + 5;
        this._theirLabel.y = 50;
        ...
        this._myMoneyLabel.x = MY_GRID_X + 5;
        this._myMoneyLabel.y = GRID_Y + GRID_ROWS * (SLOT_H + SLOT_GAP) + 6;
        this.container.addChild(this._myMoneyLabel);
        this._theirMoneyLabel = new Text({ text: '', style: _labelStyle });
        this._theirMoneyLabel.x = THEIR_GRID_X + 5;
        this._theirMoneyLabel.y = GRID_Y + GRID_ROWS * (SLOT_H + SLOT_GAP) + 6;
        ...
        this._noticeLabel.x = 20;
        this._noticeLabel.y = 292;
    ...
    OnPartnerPutItem(index, item) {
        if (index >= 0 && index < 9)
            this._theirItems[index] = item;
    }
    OnPartnerPutMoney(amount) {
    ...
    handleMouseButton(x, y, down) {
        ...
        if (this._handleMySlotClick(lx, ly))
            return true;
...
//# sourceMappingURL=TradingRoom.js.map