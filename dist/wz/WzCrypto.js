...
const ModeOfOperation = aesjs.default?.ModeOfOperation ?? aesjs.ModeOfOperation;
export class WzCrypto {
    static BatchSize = 1024;
    _aes;
    _expandedIv;
    _mask = new Uint8Array(0);
    static CreateGms() {
...
//# sourceMappingURL=WzCrypto.js.map