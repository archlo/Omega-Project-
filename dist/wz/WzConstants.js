export class WzConstants {
    static AesUserKey = new Uint8Array([
    ...
    static WzGmsIv = new Uint8Array([0x4D, 0x23, 0xC7, 0x2B]);
    static WzEmptyIv = new Uint8Array(4);
    static WzOffsetConstant = 0x581C3F6D;
}
//# sourceMappingURL=WzConstants.js.map