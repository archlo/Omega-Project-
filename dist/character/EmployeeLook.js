...
export class EmployeeLook {
    ...
    constructor(ObjId, EmployerObjId, NameTag = null) {
        this.ObjId = ObjId;
        this.EmployerObjId = EmployerObjId;
        this.NameTag = NameTag;
        this._build();
    }
    ReplayMove(path) { this._replay.SetPath(path, this.Position); }
...
//# sourceMappingURL=EmployeeLook.js.map