...
import { loadFrameSequence } from './WzFrameAnimation.js';
export class TombstoneEffect {
    ...
    Landed = false;
    OnLanded = null;
    constructor(effectWz, soundWz, loader, audio) {
    ...
    Draw(worldToScreen) {
        ...
        this._sprite.anchor.set(f.sprite.Width > 0 ? f.sprite.OriginX / f.sprite.Width : 0, f.sprite.Height > 0 ? f.sprite.OriginY / f.sprite.Height : 0);
...
//# sourceMappingURL=TombstoneEffect.js.map