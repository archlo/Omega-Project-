...
export class SummonedLook {
    ...
    MoveAction = 0;
    FacingLeft = false;
    constructor(ObjId, CharId, SkillId) {
        this.ObjId = ObjId;
        this.CharId = CharId;
    ...
    Load(loader, skillWz) {
        ...
        if (!(summonRoot instanceof WzProperty))
            summonRoot = root.Get('summoned');
        if (!(summonRoot instanceof WzProperty))
            return;
    ...
    get CurrentAction() { return this._curAction; }
    ReplayMove(path) {
...
//# sourceMappingURL=SummonedLook.js.map