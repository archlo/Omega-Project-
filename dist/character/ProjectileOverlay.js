...
export class ProjectileOverlay {
    _entries = [];
    _chainEntries = [];
    Spawn(x1, y1, x2, y2, durationMs = DefaultDurationMs, frames, fadeOut = false) {
        this._entries.push({ x1, y1, x2, y2, elapsedMs: 0, durationMs, frames, fadeOut, frameIndex: 0, frameTimerMs: 0 });
    }
    SpawnChainLightning(points, durationMs = 220) {
        if (points.length < 2)
            return;
    ...
    _drawChain(g, from, to, worldToScreen, alpha) {
...
//# sourceMappingURL=ProjectileOverlay.js.map