...
function resolveDamageBranch(jobId, weaponType, str, dex, int, luk) {
    const category = Math.floor((jobId / 100) % 10);
    if (category === 2)
        return { primary: int, secondary: luk, tertiary: 0, k: 1.0, magic: true };
    if (jobId % 1000 === 0 || jobId === 2001)
        return { primary: str, secondary: dex, tertiary: 0, k: 1.2, magic: false };
    switch (weaponType) {
        case 30:
        case 31:
        case 32: return { primary: str, secondary: dex, tertiary: 0, k: 1.2, magic: false };
        ...
        case 40:
        case 41:
        case 42: return { primary: str, secondary: dex, tertiary: 0, k: 1.32, magic: false };
        case 43:
        case 44: return { primary: str, secondary: dex, tertiary: 0, k: 1.49, magic: false };
...
function getMasteryConst(weaponType) {
...
export function calcHitRate(acc, mobEva, atkLevel, targetLevel, ar = 0) {
...
export function getWeaponType(itemId) {
    ...
    if (wt === 30 || wt === 31 || wt === 32 || wt === 33 || wt === 34 ||
        ...
        wt === 45 || wt === 46 || wt === 47 || wt === 48 || wt === 49)
        return wt;
    return 0;
}
export function calcBaseDamage(primary, secondary, tertiary, attack, k) {
...
export function calcDamageRange(jobId, weaponType, watk, matk, str, dex, int, luk, mastery) {
...
export const MeleeDamage = { Estimate: function (jobId, level, str, dex, int, luk) {
...
//# sourceMappingURL=MeleeDamage.js.map