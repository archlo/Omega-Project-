import { InventoryItem, EquipStats } from '../../domain/InventoryItem.js';
export class ItemDecoder {
    ...
    static _isRechargeable(itemId) {
        return Math.floor(itemId / 10000) === 207 || Math.floor(itemId / 10000) === 233;
    }
}
//# sourceMappingURL=ItemDecoder.js.map