...
export class MeleeTarget {
    ...
    hitAction;
    foreActionAndDir;
    constructor(mobId, damage, hitX = 0, hitY = 0, delay = 0, 
        ...
        for (const t of targets) {
            ...
            if (options.mesoExplosion) {
                ...
                if (t.damage.length !== damagePerMob) {
                    throw new Error(`MeleeTarget ${t.mobId} has ${t.damage.length} damage values but damagePerMob is ${damagePerMob}`);
                }
...
//# sourceMappingURL=MeleeAttackEncoder.js.map