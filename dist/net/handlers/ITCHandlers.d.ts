...
export declare class ITCHandlers {
    onItemList: ((items: ITCItemInfo[]) => void) | null;
    onChargeResult: ((nxCredit: number, nxPrepaid: number) => void) | null;
    onQueryCashResult: ((nxCredit: number, nxPrepaid: number) => void) | null;
    clear(): void;
    register(router: PacketRouter): void;
    private _handleItemList;
    private _handleChargeResult;
    private _handleQueryCashResult;
}
//# sourceMappingURL=ITCHandlers.d.ts.map