...
import { TrunkFlag, WhisperFlag, ShopItemPrefix, } from '../protocol/Enums.js';
...
export class FieldHandlers {
    ...
    _currentFieldType = 0;
    setCurrentFieldType(fieldType) { this._currentFieldType = fieldType; }
    ...
    onMobSpecialEffectBySkill = null;
    onMobSkillDelay = null;
    onMobSpeaking = null;
    onNpcEnter = null;
    onNpcLeave = null;
    onUserEnter = null;
    ...
    onCashItemExpire = null;
    onGiveBuff = null;
    onIncSp = null;
    onIncFame = null;
    onIncGp = null;
    onOpenUrl = null;
    onGeneralItemExpire = null;
    onItemProtectExpire = null;
    onItemExpireReplace = null;
    onWheelOfFortune = null;
    onSkillExpire = null;
    ...
    onPartyInvite = null;
    onPartyLoad = null;
    onPartyBossChanged = null;
    onPartyMemberStatChanged = null;
    onFriendList = null;
    onFriendRequest = null;
    onFriendStatusChanged = null;
    onFriendUpdate = null;
    onGuildMemberOnline = null;
    onGuildMemberJoin = null;
    onGuildMemberLeave = null;
    onGuildLoad = null;
    onGuildSetMarkPrompt = null;
    onAllianceLoad = null;
    onScriptMessage = null;
    onShopOpen = null;
    onShopResult = null;
    onAdminShopDlg = null;
    onAdminShopResult = null;
    onStoreBankResult = null;
    onStoreBankAction = null;
    onCharacterSaleCheckIdResult = null;
    onCharacterSaleCreateResult = null;
    onMonsterCarnivalEnter = null;
    onMonsterCarnivalPersonalCp = null;
    onMonsterCarnivalTeamCp = null;
    onMonsterCarnivalRequestResult = null;
    onMonsterCarnivalRequestCanned = null;
    onMonsterCarnivalProcessForDeath = null;
    onMonsterCarnivalMemberOut = null;
    onMonsterCarnivalGameResult = null;
    onFamilyChartResult = null;
    onFamilyInfoResult = null;
    onFamilyResult = null;
    onFamilyJoinRequest = null;
    onFamilyJoinRequestResult = null;
    onFamilyJoinAccepted = null;
    onFamilyPrivilegeList = null;
    onFamilyFamousPointIncResult = null;
    onFamilyNotifyLoginOrLogout = null;
    onFamilySetPrivilege = null;
    onFamilySummonRequest = null;
    onGuildBBSListResult = null;
    onGuildBBSViewEntryResult = null;
    onGuildBBSEntryNotFound = null;
    onWeddingGiftResult = null;
    onItemUpgradeResult = null;
    onInventoryGrow = null;
    onSetTamingMobInfo = null;
    onQuestClear = null;
    onGatherItemResult = null;
    onSortItemResult = null;
    onSueCharacterResult = null;
    onTradeMoneyLimit = null;
    onExpeditionResult = null;
    onPartyAdverResult = null;
    onExpeditionApply = null;
    onSetGender = null;
    onTownPortalNotify = null;
    onOpenGateNotify = null;
    onMarriageRequest = null;
    onMarriageResult = null;
    onNotifyMarriedPartnerMapTransfer = null;
    onCashPetFoodResult = null;
    onSetWeekEventMessage = null;
    onSetPotionDiscountRate = null;
    onMonsterBookSetCard = null;
    onMonsterBookSetCover = null;
    onHourChanged = null;
    onMiniMapOnOff = null;
    onConsultAuthkeyUpdate = null;
    onClassCompetitionAuthkeyUpdate = null;
    onWebBoardAuthkeyUpdate = null;
    onSessionValue = null;
    onPartyValue = null;
    onFieldSetVariable = null;
    onBonusExpRateChanged = null;
    onPotionDiscountRateChanged = null;
    onNotifyLevelUp = null;
    onNotifyWedding = null;
    onNotifyJobChange = null;
    onMapleTVUseRes = null;
    onAvatarMegaphoneRes = null;
    onSuccessInUsegachaponBox = null;
    onSetBuyEquipExt = null;
    onSetPassengerRequest = null;
    onScriptProgressMessageNotify = null;
    onDataCRCCheckFailed = null;
    onUpdateGMBoard = null;
    onShowSlotMessage = null;
    onAccountMoreInfo = null;
    onFindFriend = null;
    onTransferChannelNotify = null;
    onForcedStatSet = null;
    onForcedStatReset = null;
    onOpenFullClientDownloadLink = null;
    onShopLinkResult = null;
    onImitatedNPCData = null;
    onLimitedNPCDisableInfo = null;
    onClearAvatarMegaphone = null;
    onCancelNameChangebyOther = null;
    onWildHunterInfo = null;
    onAskWhetherUsePamsSong = null;
    onDisallowedDeliveryQuestList = null;
    onHontaleTimer = null;
    onChaosZakumTimer = null;
    onHontailTimer = null;
    onZakumTimer = null;
    onRPSGameDlg = null;
    onParcelDlg = null;
    onSummonedAttack = null;
    onSummonedSkill = null;
    onSummonedHit = null;
    onMobCrcKeyChanged = null;
    onNpcChangeController = null;
    onNpcMove = null;
    onNpcUpdateLimitedInfo = null;
    onNpcSetSpecialAction = null;
    onPetConsumeItemInit = null;
    onPetConsumeMPItemInit = null;
    onVegaResult = null;
    onAuthenCodeChanged = null;
    onLogoutGift = null;
    onTrunkResult = null;
    ...
    onReactorEnter = null;
    onReactorLeave = null;
    onReactorChangeState = null;
    onReactorMove = null;
    onEmployeeEnter = null;
    onEmployeeLeave = null;
    onSummonedEnter = null;
    onSummonedLeave = null;
    onSummonedMove = null;
    onTownPortalEnter = null;
    onTownPortalLeave = null;
    onOpenSkillGuide = null;
    onAffectedAreaCreate = null;
    onAffectedAreaRemove = null;
    onOpenGateCreate = null;
    onOpenGateRemove = null;
    onClaimResult = null;
    onClaimSvrAvailableTime = null;
    onClaimSvrStatusChanged = null;
    onMakerResult = null;
    onFieldEffect = null;
    onBlowWeather = null;
    onPlayJukeBox = null;
    onClock = null;
    onDestroyClock = null;
    onKillCountInfo = null;
    onMessageBoxCreateFailed = null;
    onMessageBoxEnterField = null;
    onMessageBoxLeaveField = null;
    onMassacreIncGauge = null;
    onMassacreResult = null;
    onBroadcastMsg = null;
    onEntrustedShopCheckResult = null;
    onSkillUseResult = null;
    onSkillLearnItemResult = null;
    onSkillResetItemResult = null;
    onSkillCooltimeSet = null;
    onSkillPrepare = null;
    onSkillCancel = null;
    onTransferFieldReqIgnored = null;
    onTransferChannelReqIgnored = null;
    onFieldSpecificData = null;
    onCoupleMessage = null;
    onSummonItemInavailable = null;
    onFieldObstacleOnOff = null;
    onFieldObstacleAllReset = null;
    onAdminResult = null;
    onQuiz = null;
    onFieldDesc = null;
    onSetQuestClear = null;
    onSetQuestTime = null;
    onWarnMessage = null;
    onSetObjectState = null;
    onStalkResult = null;
    onRequestFootHoldInfo = null;
    onAntiMacroResult = null;
    onDestroyShopResult = null;
    // OG: CUserLocal::OnFieldFadeInOut (decompile 0x9057a3)
    onFieldFadeInOut = null;
    // OG: CUserLocal::OnFieldFadeOutForce (decompile 0x9057f4)
    onFieldFadeOutForce = null;
    // OG: CUserLocal::OnNotifyHPDecByField (decompile 0x90fedb)
    onNotifyHPDecByField = null;
    // OG: CUserLocal::OnSetDirectionMode (decompile 0x905502)
    onSetDirectionMode = null;
    onMacroSysDataInit = null;
    onSetITC = null;
    onSetCashShop = null;
    // ── CWvsContext pure-gap callbacks (IDA_NEW_GAPS.md) ─────────────────
    onGivePopularityResult = null;
    onMemoResult = null;
    onMapTransferResult = null;
    onIncubatorResult = null;
    onShopScannerResult = null;
    onBridleMobCatchFail = null;
    onImitatedNPCResult = null;
    onSetAvatarMegaphone = null;
    onCancelNameChangeResult = null;
    onCancelTransferWorldResult = null;
    onFakeGMNotice = null;
    onNewYearCardRes = null;
    onRandomMorphRes = null;
    onCakePieEventResult = null;
    onStageChange = null;
    onDragonBallBox = null;
    // ── CUserPool common-packet callbacks (IDA_NEW_GAPS.md) ────────────
    onUserChatHistory = null;
    onUserADBoard = null;
    onSetConsumeItemEffect = null;
    onShowItemUpgradeEffect = null;
    onShowItemHyperUpgradeEffect = null;
    onShowItemOptionUpgradeEffect = null;
    onShowItemReleaseEffect = null;
    onShowItemUnreleaseEffect = null;
    onUserHitByUser = null;
    onUserTeslaTriangle = null;
    onUserFollowCharacter = null;
    onUserShowPQReward = null;
    onUserSetPhase = null;
    onShowRecoverUpgradeCountEffect = null;
    // ── CUserPool remote-packet callbacks (IDA_NEW_GAPS.md) ────────────
    onUserMovingShootAttackPrepare = null;
    onUserHit = null;
    onUserSetActiveEffectItem = null;
    onUserShowUpgradeTombEffect = null;
    onUserSetTemporaryStat = null;
    onUserResetTemporaryStat = null;
    onUserReceiveHP = null;
    onUserGuildNameChanged = null;
    onUserGuildMarkChanged = null;
    onUserThrowGrenade = null;
    ...
    onOpenUIWithOption = null;
    // OG: CUserLocal::OnNoticeMsg (0x9181f0) — decodeStr → CUtilDlg::Notice
    onNoticeMsg = null;
    // OG: CUser::OnChatMsg (local echo) — decodeStr → chat log add
    onUserLocalChatMsg = null;
    // OG: CUser::OnMiniRoomBalloon — decode mini room balloon info
    onMiniRoomBalloon = null;
    // ── Pet & Dragon callbacks (IDA_NEW_GAPS.md) ───────────────────────
    onPetActivated = null;
    onPetEvol = null;
    onPetMove = null;
    onPetAction = null;
    onPetNameChange = null;
    onPetLoadExceptionList = null;
    onPetActionCommand = null;
    onDragonMove = null;
    onDragonAfterMove = null;
    onDragonAction = null;
    // ── CMob gap callbacks (IDA_NEW_GAPS.md) ───────────────────────────
    onMobStatSet = null;
    onMobStatReset = null;
    onMobSuspendReset = null;
    onMobAffected = null;
    onMobCatchEffect = null;
    onMobEffectByItem = null;
    onMobIncChargeCount = null;
    onMobEscortFullPath = null;
    onMobEscortStopPerm = null;
    onMobEscortStopSay = null;
    onMobEscortReturnBefore = null;
    onMobNextAttack = null;
    onMobAttackedByMob = null;
    // ── CNpc gap callbacks (IDA_NEW_GAPS.md) ──────────────────────────
    onNpcTemplatePacket = null;
    clearAllExceptSetField() {
    ...
    register(router) {
        ...
        router.register(OutHeader.MonsterBookSetCard, (p, s) => {
            ...
            if (flag === 0) {
                this.onMonsterBookSetCard?.({ flag });
                return;
            }
        ...
        router.register(OutHeader.ForcedStatSet, (p, s) => {
            ...
            if ((mask & 0x10) !== 0)
                args.pad = p.readShort();
            if ((mask & 0x20) !== 0)
                args.pdd = p.readShort();
            if ((mask & 0x40) !== 0)
                args.mad = p.readShort();
            if ((mask & 0x80) !== 0)
                args.mdd = p.readShort();
            if ((mask & 0x100) !== 0)
                args.acc = p.readShort();
            if ((mask & 0x200) !== 0)
                args.eva = p.readShort();
            if ((mask & 0x400) !== 0)
                args.speed = p.readByte();
            if ((mask & 0x800) !== 0)
                args.jump = p.readByte();
            if ((mask & 0x1000) !== 0)
                args.speedMax = p.readByte();
    ...
    handleSetField(p, session) {
        ...
        const args = { channelId, characterId, fieldKey, isMigrate, nNotifierCheck };
        if (nNotifierCheck > 0) {
            const title = p.readString();
            const lines = [];
            for (let i = 0; i < nNotifierCheck; i++)
                lines.push(p.readString());
        ...
        if (isMigrate) {
            ...
            if (characterData.money !== undefined)
                args.money = characterData.money;
            // OG: CharacterData.equipped — populate equip panel on field entry
            if (characterData.equipped)
                args.equipped = characterData.equipped;
            if (characterData.equippedCash)
                args.equippedCash = characterData.equippedCash;
        }
        else {
        ...
        if (args.eventAlarm)
            this.onEventAlarm?.(args.eventAlarm.title, args.eventAlarm.lines);
    }
    handleMigrateCommand(p) {
        p.readByte();
        const host = p.readBytes(4);
        const port = p.readUShort();
        this.onMigrateCommand?.(host, port);
    }
    handleAliveReq(session) {
    ...
    handleStatChanged(p) {
        ...
        const args = { mask: BigInt(mask) };
        const m = mask;
        if ((m & 1 /* MapleStat.Skin */) !== 0)
            args.skin = p.readByte();
        if ((m & 2 /* MapleStat.Face */) !== 0)
            args.face = p.readInt();
        if ((m & 4 /* MapleStat.Hair */) !== 0)
            args.hair = p.readInt();
        if ((m & 8 /* MapleStat.PetSn1 */) !== 0)
            p.readLong();
        if ((m & 16 /* MapleStat.Level */) !== 0)
            args.level = p.readByte();
        if ((m & 32 /* MapleStat.Job */) !== 0) {
            args.job = p.readShort();
            this._currentJob = args.job;
        }
        if ((m & 64 /* MapleStat.Str */) !== 0)
            args.str = p.readShort();
        if ((m & 128 /* MapleStat.Dex */) !== 0)
            args.dex = p.readShort();
        if ((m & 256 /* MapleStat.Int */) !== 0)
            args.int = p.readShort();
        if ((m & 512 /* MapleStat.Luk */) !== 0)
            args.luk = p.readShort();
        if ((m & 1024 /* MapleStat.Hp */) !== 0)
            args.hp = p.readInt();
        if ((m & 2048 /* MapleStat.MaxHp */) !== 0)
            args.maxHp = p.readInt();
        if ((m & 4096 /* MapleStat.Mp */) !== 0)
            args.mp = p.readInt();
        if ((m & 8192 /* MapleStat.MaxMp */) !== 0)
            args.maxMp = p.readInt();
        if ((m & 16384 /* MapleStat.Ap */) !== 0)
            args.ap = p.readShort();
        ...
        if ((m & 65536 /* MapleStat.Exp */) !== 0)
            args.exp = p.readInt();
        if ((m & 131072 /* MapleStat.Pop */) !== 0)
            args.pop = p.readShort();
        if ((m & 262144 /* MapleStat.Meso */) !== 0)
            args.meso = p.readInt();
        if ((m & 524288 /* MapleStat.PetSn2 */) !== 0)
            p.readLong();
        if ((m & 1048576 /* MapleStat.PetSn3 */) !== 0)
            p.readLong();
        ...
        if ((m & 2097152 /* MapleStat.TempExp */) !== 0)
            p.readInt();
    ...
    handleMobHpIndicator(p) {
        const mobId = p.readInt();
        const pct = p.readByte();
        this.onMobHpIndicator?.(mobId, pct);
    }
    handleMobSpecialEffectBySkill(p) {
    ...
    handleUserAttack(p, attackType) {
        ...
        try {
            ...
            if (action > 0x110) {
                this.onUserAttack?.({ charId, attackType, skillId, slv, action, facingLeft, actionSpeed: 0, mastery: 0, bulletItemId: 0, targets: [] });
                return;
            }
    ...
    handleUserEmotionLocal(p) {
        const emotion = p.readInt();
        const duration = p.readInt();
        const byItem = p.readBool();
        this.onUserEmotion?.({ charId: 0, emotion, durationMs: duration, byItemOption: byItem });
    }
    handleUserEffect(p, isLocal) {
        const charId = isLocal ? 0 : p.readInt();
        const effectType = p.readByte();
        const payload = p.readBytes(p.remaining);
        this.onUserEffect?.({ charId, effectType, payload, isLocal });
    }
    handleUserSetActivePortableChair(p) {
        const charId = p.readInt();
        const itemId = p.readInt();
        this.onUserSetActivePortableChair?.({ charId, itemId });
    }
    handleUserAvatarModified(p) {
        const charId = p.readInt();
        const flags = p.readByte();
        let look;
        if (flags & 1)
            look = AvatarCodec.DecodeAvatarLook(p);
        let speed;
        if (flags & 2)
            speed = p.readByte();
        let carryItemEffect;
        if (flags & 4)
            carryItemEffect = p.readByte();
        let coupleItemSN;
        let pairItemSN;
        let coupleCharacterId;
        if (p.readByte()) {
            coupleItemSN = p.readLong();
            pairItemSN = p.readLong();
            coupleCharacterId = p.readInt();
        }
        let friendshipItemSN;
        let friendshipPairItemSN;
        let friendCharacterId;
        if (p.readByte()) {
            friendshipItemSN = p.readLong();
            friendshipPairItemSN = p.readLong();
            friendCharacterId = p.readInt();
        }
        let marriageCharacterId;
        let marriagePairCharacterId;
        let weddingRingId;
        if (p.readByte()) {
            marriageCharacterId = p.readInt();
            marriagePairCharacterId = p.readInt();
            weddingRingId = p.readInt();
        }
    ...
    handleDropEnter(p) {
        ...
        const hasSourcePos = enterType !== 2 /* DropEnterType.OnTheFoothold */;
        const animated = enterType === 1 /* DropEnterType.Create */;
        let sx = x, sy = y;
        if (hasSourcePos) {
            try {
                sx = p.readShort();
    ...
    handleDropLeave(p) {
        ...
        const dropId = p.readInt();
        let pickUpId = 0;
        if (leaveType === 2 /* DropLeaveType.PickedUpByUser */
            || leaveType === 3 /* DropLeaveType.PickedUpByMob */
            || leaveType === 5 /* DropLeaveType.PickedUpByPet */) {
            try {
                pickUpId = p.readInt();
            }
            catch { }
    ...
    handleMessage(p) {
        ...
        switch (msgType) {
            case 3 /* MessageType.IncExp */:
                ...
                break;
            case 6 /* MessageType.IncMoney */:
                this.onIncMoney?.(p.readInt());
                break;
            case 0 /* MessageType.LootWarning */: {
                ...
                const args = { warning: subtype, isMoney: false };
                switch (subtype) {
                    case 0 /* LootSubType.ItemWarning */:
                        args.itemId = p.readInt();
                        args.quantity = p.readInt();
                        break;
                    case 2 /* LootSubType.ItemExpire */:
                        args.itemId = p.readInt();
                        break;
                    case 1 /* LootSubType.MoneyWarning */:
                        args.isMoney = true;
                        p.readByte();
            ...
            case 1 /* MessageType.QuestRecord */: {
                ...
                let value = '';
                if (state === 1 /* QuestRecordState.Started */)
                    value = p.readString();
                else if (state === 2 /* QuestRecordState.Completed */)
                    p.readLong();
                this.onQuestRecord?.({ questId, state, value, isEx: false });
                break;
            }
            case 11 /* MessageType.QuestRecordEx */: {
                const questId = p.readShort();
                const value = p.readString();
                this.onQuestRecord?.({ questId, state: 1 /* QuestRecordState.Started */, value, isEx: true });
                break;
            }
            case 2 /* MessageType.CashItemExpire */: {
                const itemId = p.readInt();
                this.onCashItemExpire?.({ itemId });
                break;
            }
            case 4 /* MessageType.IncSp */: {
            ...
            case 8 /* MessageType.GiveBuff */: {
                const itemId = p.readInt();
                this.onGiveBuff?.({ itemId });
                break;
            }
            case 10 /* MessageType.System */: {
                const text = p.readString();
                this.onSystemMessage?.({ text, type: msgType });
                break;
            }
            case 16 /* MessageType.OpenURL */: {
                const url = p.readString();
                this.onOpenUrl?.({ url });
                break;
            }
            case 15 /* MessageType.EncryptedMessage */: {
                const text = p.readString();
                console.debug('EncryptedMessage:', text);
                break;
            }
            case 9 /* MessageType.GeneralItemExpire */: {
                ...
                const itemIds = [];
                for (let i = 0; i < count; i++)
                    itemIds.push(p.readInt());
                this.onGeneralItemExpire?.(itemIds);
                break;
            }
            case 12 /* MessageType.ItemProtectExpire */: {
            ...
            case 13 /* MessageType.ItemExpireReplace */: {
                ...
                const messages = [];
                for (let i = 0; i < count; i++)
                    messages.push(p.readString());
                this.onItemExpireReplace?.(messages);
                break;
            }
            case 17 /* MessageType.WheelOfFortune */: {
                const text = p.readString();
                this.onWheelOfFortune?.(text);
                break;
            }
            case 14 /* MessageType.SkillExpire */: {
                const count = p.readByte();
                const skillIds = [];
                for (let i = 0; i < count; i++)
                    skillIds.push(p.readInt());
        ...
        for (let i = 0; i < count; i++) {
            ...
            switch (opType) {
                case 0 /* InventoryOpType.Add */:
                    ...
                    break;
                case 1 /* InventoryOpType.QuantityChange */:
                    op.quantity = p.readShort();
                    break;
                case 2 /* InventoryOpType.Move */: {
                    const newPos = p.readShort();
                    op.newPos = newPos;
                    if (invType === 1 && (pos < 0 || newPos < 0))
                        hasEquipSlotChange = true;
                    break;
                }
                case 3 /* InventoryOpType.Remove */:
                    if (invType === 1 && pos < 0)
                        hasEquipSlotChange = true;
                    break;
                case 4 /* InventoryOpType.UpdateExp */:
                    op.equipExp = p.readInt();
                    break;
            }
            ops.push(op);
        }
    ...
    handleSetClaimSvrAvailableTime(p) {
    ...
    handlePartyResult(p) {
        ...
        switch (resultType) {
            ...
            case 7 /* PartyResultType.Load */:
                p.readInt();
                this._emitPartyData(p);
                break;
            case 15 /* PartyResultType.Join */:
                p.readInt();
                p.readString();
                this._emitPartyData(p);
                break;
            case 12 /* PartyResultType.Withdraw */:
                p.readInt();
                p.readInt();
                if (p.readBool()) {
                    p.readByte();
                ...
                break;
            case 8 /* PartyResultType.CreateDone */:
                p.readInt();
                p.readInt();
                p.readInt();
                p.readInt();
                ...
                p.readShort();
                break;
            case 38 /* PartyResultType.ReloadParty */:
                try {
                    this._emitPartyData(p);
                }
                catch { /* skip */ }
                break;
            case 31 /* PartyResultType.ChangeBoss */: {
                const newBossCharId = p.readInt();
                p.readByte();
                this.onPartyBossChanged?.(newBossCharId);
                break;
            }
            case 39 /* PartyResultType.LevelJobChanged */: {
                const charId = p.readInt();
    ...
    _decodeAdverCommon(p, nGroupID, isExpedition) {
    ...
    _emitPartyData(p) {
        ...
        for (let i = 0; i < PartyMax; i++)
            charIds.push(p.readInt());
        for (let i = 0; i < PartyMax; i++)
            names.push(p.readString(13));
        for (let i = 0; i < PartyMax; i++)
            jobs.push(p.readInt());
        for (let i = 0; i < PartyMax; i++)
            levels.push(p.readInt());
        for (let i = 0; i < PartyMax; i++)
            channels.push(p.readInt());
        ...
        for (let i = 0; i < PartyMax; i++) {
            ...
            p.readInt();
            p.readInt();
            p.readInt(); // town portals (5 ints each)
        }
        const hps = [];
        const maxHps = [];
        for (let i = 0; i < PartyMax; i++)
            hps.push(p.readInt());
        for (let i = 0; i < PartyMax; i++)
            maxHps.push(p.readInt());
        p.readInt();
        p.readInt(); // trailing 2 ints
        const members = [];
        for (let i = 0; i < PartyMax; i++) {
            if (charIds[i] === 0)
                continue;
    ...
    handleFriendResult(p) {
        const resultType = p.readByte();
        switch (resultType) {
            case 7 /* FriendResultType.Load */:
            case 10 /* FriendResultType.Set */:
            case 18 /* FriendResultType.Delete */: {
                const count = p.readByte();
                const friends = [];
                for (let i = 0; i < count; i++) {
            ...
            case 9 /* FriendResultType.Request */: {
                const friendId = p.readInt();
            ...
            case 8 /* FriendResultType.UpdateFriend */: {
            ...
            case 20 /* FriendResultType.StatusChanged */: {
                const friendId = p.readInt();
    ...
    handleGuildResult(p) {
        ...
        switch (resultType) {
            ...
            case 41 /* GuildResultType.MemberJoin */:
                ...
                break;
            case 63 /* GuildResultType.OnlineStatus */:
                ...
                break;
            case 66 /* GuildResultType.GradeChange */:
                ...
                break;
            case 69 /* GuildResultType.MarkChange */:
                ...
                break;
            case 46 /* GuildResultType.Leave */:
            case 49 /* GuildResultType.Expel */:
                ...
                break;
            case 17 /* GuildResultType.SetMarkPrompt */:
                this.onGuildSetMarkPrompt?.();
                break;
            case 71 /* GuildResultType.NoticeChange */:
                ...
                try {
                    ...
                    if (notice)
                        this.onSystemMessage?.({ text: `[Guild Notice] ${notice}`, type: 12 });
                }
                catch { /* skip */ }
                break;
            case 75 /* GuildResultType.PointLevel */:
    ...
    _decodeGuildDataMembers(p) {
        ...
        p.readInt();
        p.readInt();
        p.readByte(); // 3 more plain fields
        const skillCount = p.readShort();
        for (let i = 0; i < skillCount; i++) {
            p.readInt(); // skill ID
            p.readShort();
            p.skip(8);
            p.readString(); // GUILDDATA::SKILLENTRY: nLevel(Decode2) + dateExpire(DecodeBuffer 8) + strBuyCharacterName(DecodeStr) — confirmed decompile/4F8A10.c
        }
        return members;
    }
    handleAllianceResult(p) {
        ...
        switch (subType) {
            case 12 /* AllianceResultType.Clear */:
                this._allianceName = '';
                this._allianceMembers = [];
                this.onAllianceLoad?.(null);
                break;
            case 16 /* AllianceResultType.FullLoad */:
                ...
                break;
            case 15 /* AllianceResultType.FullReload */:
                ...
                break;
            case 18 /* AllianceResultType.GuildJoin */:
                ...
                break;
            case 23 /* AllianceResultType.MetadataUpdate */:
                ...
                break;
            case 26 /* AllianceResultType.GradeNamesUpdate */:
                ...
                break;
            case 27 /* AllianceResultType.OwnGradeChange */:
                ...
                break;
            case 13 /* AllianceResultType.MemberUpdate */:
                try {
                    const count = p.readInt();
                    this._allianceMembers = [];
                    for (let i = 0; i < count; i++)
                ...
                break;
            case 3 /* AllianceResultType.SetNotice */:
                ...
                break;
            case 14 /* AllianceResultType.MemberGradeChange */:
                ...
                break;
            case 24 /* AllianceResultType.MemberStatUpdate */:
                ...
                break;
            case 25 /* AllianceResultType.ChangeMasterResult */:
                ...
                try {
                    ...
                    for (const m of this._allianceMembers) {
                        if (m.characterId === oldId)
                            m.grade = 2;
                        if (m.characterId === newId)
                            m.grade = 1;
                    }
                    this.onAllianceLoad?.({ allianceName: this._allianceName, members: this._allianceMembers });
                }
    ...
    handleScriptMessage(p) {
        p.readByte();
        const speakerId = p.readInt();
        const msgType = p.readByte();
        const messageParam = p.readByte();
        const args = { speakerId, msgType, messageParam, text: '', hasPrev: false, hasNext: false };
        try {
            switch (msgType) {
                case 0 /* ScriptMessageType.Say */:
                    if ((messageParam & 4 /* ScriptMessageParam.SpeakerOnRight */) !== 0)
                        p.readInt();
                    args.text = p.readString();
                    args.hasPrev = p.readBool();
                    args.hasNext = p.readBool();
                    break;
                case 1 /* ScriptMessageType.SayImage */:
                case 2 /* ScriptMessageType.AskYesNo */:
                    args.text = p.readString();
                    break;
                case 13 /* ScriptMessageType.AskAccept */: {
                    args.text = p.readString();
                    const questRe = /#q(\d+)#/;
                ...
                case 5 /* ScriptMessageType.AskMenu */: {
                    args.text = p.readString();
                    const menuItems = [];
                ...
                case 6 /* ScriptMessageType.AskQuiz */:
                    ...
                    break;
                case 14 /* ScriptMessageType.AskBoxText */:
                    args.text = p.readString();
                    args.defaultText = p.readString();
                    args.minLength = p.readShort();
                    args.maxLength = p.readShort();
                    ...
                    break;
                case 4 /* ScriptMessageType.AskNumber */:
                    args.text = p.readString();
                    args.defaultNum = p.readInt();
                    args.minNum = p.readInt();
                    args.maxNum = p.readInt();
                    break;
                case 8 /* ScriptMessageType.AskAvatar */:
                case 9 /* ScriptMessageType.AskMemberShopAvatar */: {
                    args.text = p.readString();
                    const count = p.readByte();
                    args.avatars = [];
                    for (let i = 0; i < count; i++)
                        args.avatars.push(p.readInt());
                    break;
                }
                case 10 /* ScriptMessageType.AskPet */:
                case 11 /* ScriptMessageType.AskPetAll */: {
                    args.text = p.readString();
                    const petCount = p.readByte();
                    args.pets = [];
                    for (let i = 0; i < petCount; i++)
                        args.pets.push(p.readInt());
                    break;
                }
                case 15 /* ScriptMessageType.AskSlideMenu */: {
                    args.text = p.readString();
    ...
    handleShopResult(p) {
        const resultType = p.readByte();
        const args = { resultType };
        try {
            if (resultType === 14 /* ShopResultType.NotEnoughMesos */ || resultType === 15 /* ShopResultType.NotEnoughItems */)
                args.shortfall = p.readInt();
            else if (resultType === 19 /* ShopResultType.NoItemsInStock */ && p.readBool())
                args.message = p.readString();
        }
        catch { /* skip */ }
        this.onShopResult?.(args);
    }
    static ADMIN_SHOP_REOPEN_ACTIONS = new Set([1, 2, 3, 6, 7, 8, 11]);
    handleAdminShopDlg(p) {
        const action = p.readByte();
        this.onAdminShopDlg?.({ action, shouldReopen: FieldHandlers.ADMIN_SHOP_REOPEN_ACTIONS.has(action) });
    }
    handleAdminShopResult(p) {
        const npcTemplateId = p.readInt();
        const itemCount = p.readShort();
        this.onAdminShopResult?.({ npcTemplateId, itemCount });
    }
    handleStoreBankResult(p) {
        const resultCode = p.readByte();
        this.onStoreBankResult?.({ resultCode });
    }
    handleStoreBankAction(p) {
        const subAction = p.readByte();
        const args = { subAction };
        if (subAction === 0x24) {
    ...
    handleFamilyInfoResult(p) {
        ...
        const privilegeUse = [];
        for (let i = 0; i < count; i++)
            privilegeUse.push({ key: p.readInt(), value: p.readInt() });
    ...
    // 8=EntryNotFound.
    handleGuildBBSPacket(p) {
        const sub = p.readByte();
        if (sub === 6)
            this._handleGuildBBSLoadListResult(p);
        else if (sub === 7)
            this._handleGuildBBSViewEntryResult(p);
        else if (sub === 8)
            this.onGuildBBSEntryNotFound?.();
    }
    _readGuildBBSEntry(p) {
    ...
    _handleGuildBBSLoadListResult(p) {
        ...
        for (let i = 0; i < listCount; i++)
            entries.push(this._readGuildBBSEntry(p));
        this.onGuildBBSListResult?.({ notice, totalCount, entries });
    }
    _handleGuildBBSViewEntryResult(p) {
        const entryId = p.readInt();
        const characterId = p.readInt();
        const date = p.readLong();
        const title = p.readString();
    ...
    handleTrunkResult(p) {
        const resultType = p.readByte();
        const args = { resultType, items: [] };
        try {
            switch (resultType) {
                case 22 /* TrunkResultType.Open */:
                    args.templateId = p.readInt();
                    this._decodeTrunk(p, args);
                    break;
                case 9 /* TrunkResultType.PutSync */:
                case 13 /* TrunkResultType.PutItem */:
                case 15 /* TrunkResultType.Store */:
                case 19 /* TrunkResultType.SortResult */:
                    this._decodeTrunk(p, args);
                    break;
                case 24 /* TrunkResultType.SortTrunk */:
                    if (p.readBool())
                        args.message = p.readString();
                    break;
            }
    ...
    _readTrunkBlock(p, flag, bit, invType, args) {
        if ((flag & bit) === 0n)
            return;
        const count = p.readByte();
        for (let i = 0; i < count; i++) {
    ...
    handleQuickslotMappedInit(p) {
        p.readBool();
        if (p.remaining < 32)
            return;
        const keys = [];
        for (let i = 0; i < 8; i++)
            keys.push({ key: p.readInt() });
    ...
    handleFootHoldInfo(p) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            const footholdSns = [];
            for (let j = 0; j < snCount; j++)
                footholdSns.push(p.readInt());
            const entry = { objName, curState, footholdSns };
            if (curState === 2) {
                entry.moving = {
    ...
    handleMiniRoom(p) {
        ...
        try {
            switch (action) {
                case 1 /* MiniRoomProtocol.MRP_CreateResult */:
                    args.roomType = p.readByte();
                    break;
                case 3 /* MiniRoomProtocol.MRP_InviteResult */:
                    args.inviteType = p.readByte();
                    if (args.inviteType !== 1)
                        args.targetName = p.readString();
                    break;
                case 5 /* MiniRoomProtocol.MRP_EnterResult */:
                    args.roomType = p.readByte();
                    if (args.roomType === 0) {
                    ...
                    break;
                case 6 /* MiniRoomProtocol.MRP_Chat */:
                    ...
                    break;
                case 10 /* MiniRoomProtocol.MRP_Leave */:
                    args.userIndex = p.readByte();
                    args.leaveType = p.readByte();
                    break;
                case 15 /* MiniRoomProtocol.TRP_PutItem */:
                    args.userIndex = p.readByte();
                    args.index = p.readByte();
                    args.item = ItemDecoder.Decode(p);
                    break;
                case 16 /* MiniRoomProtocol.TRP_PutMoney */:
                    args.userIndex = p.readByte();
                    args.money = p.readInt();
                    break;
                case 17 /* MiniRoomProtocol.TRP_Trade */:
                    break;
                case 19 /* MiniRoomProtocol.TRP_MoveItemToInventory */:
                    break;
                case 24 /* MiniRoomProtocol.PSP_BuyResult */:
                    args.resultCode = p.readByte();
                    break;
                case 25 /* MiniRoomProtocol.PSP_Refresh */:
                    const count = p.readByte();
                    args.items = [];
                    for (let i = 0; i < count; i++) {
                        const setCount = p.readShort();
                    ...
                    break;
                case 26 /* MiniRoomProtocol.PSP_AddSoldItem */:
                    args.itemIndex = p.readByte();
                    args.quantity = p.readShort();
                    args.buyerName = p.readString();
                    break;
                case 0 /* MiniRoomProtocol.MRP_Create */:
                    break;
                case 2 /* MiniRoomProtocol.MRP_Invite */:
                    args.targetName = p.readString();
                    break;
                case 4 /* MiniRoomProtocol.MRP_Enter */:
                    break;
                case 18 /* MiniRoomProtocol.TRP_UnTrade */:
                    break;
                case 22 /* MiniRoomProtocol.PSP_PutItem */:
                    args.index = p.readByte();
                    args.item = ItemDecoder.Decode(p);
                    break;
                case 23 /* MiniRoomProtocol.PSP_BuyItem */:
                    args.index = p.readByte();
                    args.quantity = p.readShort();
                    break;
    ...
    handleUserMiniRoomBalloon(p) {
        const ownerId = p.readInt();
        const miniRoomType = p.readByte();
        p.readByte();
        const title = p.readString();
        const pwd = p.readByte() !== 0;
        this.onMiniRoom?.(11 /* MiniRoomProtocol.MRP_Balloon */, { action: 11 /* MiniRoomProtocol.MRP_Balloon */, balloon: true, ownerId, miniRoomType, title, pwd });
    }
    handleEmployeeMiniRoomBalloon(p) {
        const ownerId = p.readInt();
        const miniRoomType = p.readByte();
        p.readByte();
        const title = p.readString();
        const pwd = p.readByte() !== 0;
        this.onMiniRoom?.(11 /* MiniRoomProtocol.MRP_Balloon */, { action: 11 /* MiniRoomProtocol.MRP_Balloon */, balloon: true, ownerId, miniRoomType, title, pwd, isEmployee: true });
    }
    handleReactorEnter(p) {
    ...
    handleTransferFieldReqIgnored(p) {
        try {
    ...
    handleTransferChannelReqIgnored(p) {
        try {
    ...
    handleSummonItemInavailable(p) {
        try {
            if (p.readByte() === 0)
                this.onSummonItemInavailable?.();
        }
        catch { /* malformed */ }
    }
    // CField::OnFieldObstacleOnOff (decompile/535A80.c) — single entry.
    handleFieldObstacleOnOff(p) {
        try {
            const name = p.readString();
    ...
    handleFieldObstacleOnOffStatus(p) {
        try {
            const count = p.readInt();
            const entries = [];
            for (let i = 0; i < count; i++) {
    ...
    handleFieldObstacleAllReset(_p) {
    ...
    handleQuiz(p) {
        try {
            ...
            if (problemId === 0)
                return; // OG: !v2 -> goto LABEL_43 (clear problem, no display)
    ...
    handleMacroSysDataInit(p) {
        try {
            ...
            for (let i = 0; i < count; i++) {
                ...
                const skills = [p.readInt(), p.readInt(), p.readInt()];
    ...
    handleEntrustedShopCheckResult(p) {
    ...
    handleGivePopularityResult(p) {
        try {
            const subResult = p.readByte();
            const args = { subResult };
            if (subResult === 0) {
                args.name = p.readString();
    ...
    handleMapTransferResult(p) {
        try {
            const subAction = p.readByte();
            const isEx = p.readByte() !== 0;
            const args = { subAction, isEx };
            if (subAction === 2 || subAction === 3) {
                const count = isEx ? 10 : 5;
                const mapIds = [];
                for (let i = 0; i < count; i++)
                    mapIds.push(p.readInt());
                args.mapIds = mapIds;
            }
    ...
    handleIncubatorResult(p) {
        try {
            const args = { itemId: p.readInt() };
            args.plus = p.readInt();
    ...
    handleBridleMobCatchFail(p) {
        try {
            const args = { reason: p.readByte(), itemId: p.readInt() };
    ...
    handleImitatedNPCResult(p) {
        try {
            const args = { templateOrResult: p.readShort() };
            this.onImitatedNPCResult?.(args);
        }
        catch { /* malformed */ }
    }
    /** OG: CWvsContext::OnSetAvatarMegaphone (0xA017E0, opcode 115). */
    handleSetAvatarMegaphone(p) {
        try {
            const charId = p.readInt();
            const name = p.readString();
            const messages = [
    ...
    handleCancelNameChangeResult(p) {
        try {
            const result = p.readByte();
            const args = { result };
    ...
    handleCancelTransferWorldResult(p) {
        try {
            const result = p.readByte();
            const args = { result };
    ...
    handleShowItemHyperUpgradeEffect(p) {
        try {
            const charId = p.readInt();
            const result = p.readByte();
            let itemId;
    ...
    handleShowItemOptionUpgradeEffect(p) {
        try {
            const charId = p.readInt();
            const result = p.readByte();
            let itemId;
    ...
    handleUserSetPhase(p) {
        try {
            this.onUserSetPhase?.({ charId: p.readInt(), phase: p.readByte() });
        }
        catch { /* malformed */ }
    }
    handleShowRecoverUpgradeCountEffect(p) {
        try {
    ...
    handleUserMovingShootAttackPrepare(p) {
        try {
            const charId = p.readInt();
            const level = p.readByte();
    ...
    handleUserSetActiveEffectItem(p) {
        try {
    ...
    handleUserShowUpgradeTombEffect(p) {
        try {
            const charId = p.readInt();
            const value = p.readInt();
    ...
    handleUserResetTemporaryStat(p) {
        try {
            const charId = p.readInt();
            const maskLo = p.readLong();
            const maskHi = p.readLong();
    ...
    handlePetActivated(p, triggerInteract) {
        try {
            const charId = p.readInt();
            ...
            if (triggerInteract && hasPet)
                this.onPetAction?.({ charId, petIdx, type: 0, actionNo: 0, chat: '', flag: 0 });
        }
        catch { /* malformed */ }
    }
    ...
    handleMobNextAttack(p) {
        try {
            this.onMobNextAttack?.({ mobId: p.readInt() });
        }
        catch { /* malformed */ }
    }
    handleMobAttackedByMob(p) {
        try {
...
function isBitSet(lo, hi, bit) {
    if (bit < 64n)
        return (lo & (1n << bit)) !== 0n;
    return (hi & (1n << (bit - 64n))) !== 0n;
}
//# sourceMappingURL=FieldHandlers.js.map