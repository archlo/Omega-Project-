...
# Use py_eval with correct 'code' parameter
$pythonCode = @"
import idaapi
import idautils
import idc
...
# Save raw response
[System.IO.File]::WriteAllText("C:\Users\jorge\OneDrive\Desktop\ts\ida_output\raw_response_py2.txt", $fullData, [System.Text.Encoding]::UTF8)
